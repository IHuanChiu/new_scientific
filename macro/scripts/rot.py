...
if not os.path.exists(name):
   ...
   exit(0)
gSystem.Unlink("/Users/chiu.i-huan/Desktop/new_scientific/run/root/MLEM_output/anim.gif")
a=input("number of thetas (rec.:10):")
b=input("number of phis (rec.:100):")

c1=createRatioCanvas("rotation", 1500, 1500)
...
c1.SetTheta(15)
c1.SetPhi(0)
c1.Print("/Users/chiu.i-huan/Desktop/new_scientific/run/root/MLEM_output/anim.gif+");
...
for itheta in range(n_thetas):
   for iphi in range(n_phis):
       ...
       c1.SetTheta(15+n_thetas*10)
       c1.SetPhi(iphi*360/n_phis+0.1)
       c1.Print("/Users/chiu.i-huan/Desktop/new_scientific/run/root/MLEM_output/anim.gif+{}".format(iphi+itheta*n_phis))
if prog: prog.finalize()
log().info("Path of gif: {}".format("/Users/chiu.i-huan/Desktop/new_scientific/run/root/MLEM_output/anim.gif"))
