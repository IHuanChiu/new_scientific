...
for _if in name_list:
   ...
   f_mlem=ROOT.TFile("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/myMLEMoutput_1116_{}_iteration100.root".format(_if),"read")
   ...
   c3.Print("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/performance_{}.pdf".format(_if))
