...
gSystem.Unlink("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter.gif")
gSystem.Unlink("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter_2d.gif")
gSystem.Unlink("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter_pro.gif")
   ...
   for it in range(n_iterations):
      for ip in range(0,n_angles):
          ...
          if c != 0:
             ...
             _h3.Draw("BOX2Z")
          c1.Print("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter.gif+{}".format(ip+it*n_angles))
...
for it in range(n_iterations):
   for ip in range(0,n_angles):
       ...
       c2.cd(2)
       _h2.Draw("colz")
       c2.Print("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter_2d.gif+{}".format(ip+it*n_angles))
if prog: prog.finalize()
...
for it in range(n_iterations):
   for ip in range(0,n_angles):
       ...
       c3.cd(3)
       _hz.Draw("hist")
       c3.Print("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/anim_iter_pro.gif+{}".format(ip+it*n_angles))
if prog: prog.finalize()

log().info("Path of gif: {}".format("/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/root/MLEM_output/"))
