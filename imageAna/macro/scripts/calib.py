...
#             else: element_list = self.element_list_nside
      ...
      def plot(self):
          ...
          ROOT.SetAtlasStyle()
          c0name="/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/figs/cali_plots/"+self.voltage+"/hist_"+self.source+"_all.pdf"
          c1name="/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/figs/cali_plots/"+self.voltage+"/hist_"+self.source+"_fit.pdf"
          c2name="/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/figs/cali_plots/"+self.voltage+"/hist_"+self.source+"_gr.pdf"
