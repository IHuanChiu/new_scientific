...
c1->Print(name + "[", "pdf");
for (int i = 0; i < 128; i++){
  t->Draw("E_p_lv1 >> h1(600,0,150)",Form("Stripid_x_lv1==%d && nsignalx_lv1 == 1 && nsignaly_lv1 == 1",i));
...
for (int i = 128; i < 256; i++){
  t->Draw("E_n_lv1 >> h1(600,0,150)",Form("Stripid_y_lv1==%d && nsignalx_lv1 == 1 && nsignaly_lv1 == 1",i));
  TH1D* h1=(TH1D*)gDirectory->Get("h1");
  h1->SetTitle(Form("Ch : %d",i));
  h1->SetStats(0);
