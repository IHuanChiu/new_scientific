...
#       h3d=SBP.h3d
    ...
    SetMyPalette("RB",0.5)
    h3d_t.Draw("BOX2Z")
    if args.output is not None: _outfig = "/Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/figs/hist_3D_image."+args.dtype+"."+args.output+"_cut{}.ROOT.pdf".format(args.cut) 
    ...
    if args.input3Dhist is None: 
       ...
       log().info("Output : %s, in: /Users/chiu.i-huan/Desktop/new_scientific/imageAna/run/figs"%(outname))
